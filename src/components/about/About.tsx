        ...
        <h2 className="About-title">About me</h2>
          <div className="About-primary">
            <p>
              ...
              My interest in web development started back in december of 2021 when
              i discovered HTML, CSS & JS course online. Turns out i've found my dream
              world through coding.
            </p> <br />
            <p>
              Since then i've had the opportunity to work on real projects as Frontend Dev.
              My main focus these days is building user friendly websites and learning more
